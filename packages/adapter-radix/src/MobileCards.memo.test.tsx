...
describe("mobile card memoization (Radix)", () => {
...
describe("summary aggregation (Radix)", () => {
...
describe("selected state on mobile cards (Radix)", () => {
...
describe("an empty mobileLabel (Radix)", () => {
