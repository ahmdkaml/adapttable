...
describe("mobile card memoization (Chakra)", () => {
...
describe("summary aggregation (Chakra)", () => {
...
describe("selected state on mobile cards (Chakra)", () => {
...
describe("an empty mobileLabel (Chakra)", () => {
