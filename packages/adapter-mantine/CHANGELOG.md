...
- c4a6d06: Selects inside the Filters card portal above the popover, so an option is
  clickable instead of sitting under the card.
...
- bb6f970: Wide tables scroll sideways again. Columns with fixed pixel widths are supposed
...
- d3946de: Escape closes the Columns and Saved-views menus.
