 ...
 */
describe("column virtualization (mantine)", () => {
  ...
  /** Kit-agnostic: the header's own cells, never the core spacers. */
  const headerCells = () =>
  ...
  it("windows the columns once the box reports a width", () => {
    ...
    // Core names the element every kit scrolls, whatever the kit calls it.
