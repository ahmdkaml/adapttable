/**
 * summaryRow, header groups, and multiSort for the Base UI table. Base UI
...
/** The data-summary row Base UI appends to the tbody, if present. */
...
describe("header groups (Base UI)", () => {
